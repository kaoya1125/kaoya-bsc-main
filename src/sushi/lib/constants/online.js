...
export const contractAddresses = {
  ...
  masterChef: {
    ...
    1: '0x8961FFec3b89A8599e2A1C921f66c87B92D13E02', // aelf master
  },
  weth: {
...
export const supportedLendingInvestmentPools = [
  {
    lpAddress: '0x3fa4b0b3053413684d0b658689ede7907bb4d69d', // WETH-KAOYA
...
export const supportedInvestmentPools = [
  {
    lpAddresses: {
      ...
      1: '0x4b618087DaE7765823BC47fFbF38C8Ee8489F5CA', // WETH-KAOYA UNI LP
    },
    pivotLpAddresses: {
  ...
  // DeForce Investment
  {
    lpAddresses: {
      42: '0x4b618087DaE7765823BC47fFbF38C8Ee8489F5CA',
      1: '0x4b618087DaE7765823BC47fFbF38C8Ee8489F5CA', // ETH-KAOYA
    },
    pivotLpAddresses: {
  ...
  //     1: '0x4b618087dae7765823bc47ffbf38c8ee8489f5ca', // WETH-KAOYA
  //   },
  //   pivotLpAddresses: {
  //     42: '0x7c2580099eF4c34B788d3f3A192817f35dd68f8A',
  //     1: '0x9776a214272ab452f8c88c7576dcd0c6ffbfee14' // GOF-ETH
  ...
  //     // 1: '0xaf46c4cf1cb2a669ce2f7bc1e7a53f0da8c7c574', // HT-KAOYA UNI LP
  //     1: '0x4b618087dae7765823bc47ffbf38c8ee8489f5ca', // WETH-KAOYA UNI LP
  //     // 1: '0xceea282be8da0f3f4b2bc57bfd89f4b7dd4454b1', // HT-KAOYA KALP
  //   },
  //   pivotLpAddresses: {
  //     42: '0x7c2580099eF4c34B788d3f3A192817f35dd68f8A',
  //     1: '0x9776a214272ab452f8c88c7576dcd0c6ffbfee14' // GOF-ETH
...
const newHiddenPool1215 = [
  // Lending, Hidden.
  // Not lp, is ERC20 token named lKAOYA
  {
    pid: 55,
    lpAddresses: {
...
const newNormalPool1124 = [
  ...
  },
  {
    ...
    uniV2Pivot: true,
    uniV2LPAddress: '0x3fa4b0b3053413684d0b658689ede7907bb4d69d', // ETH-KAOYA
    sashimiPlateInfo: {
      mainTokenIndex: 1, // eg. DAI-ETH, DAI-> 0, ETH-DAI, DAI-> 1
      tokensDecimal: [18, 18],
      type: 10, // for normal pool
...
export const supportedPools = [
  ...
  },
  {
    ...
    name: 'USDT love KaoYa!',
    symbol: 'USDT-KAOYA KALP LP',
    tokenSymbol: 'USDT',
    icon: '🍻',
  },
  {
    ...
    name: 'USDC love KaoYa!',
    symbol: 'USDC-KAOYA KALP LP',
    tokenSymbol: 'USDC',
    icon: '🍷',
  },
  ...
  },
  {
    ...
    name: 'YFII love KaoYa!',
    symbol: 'YFII-KAOYA KALP LP',
    tokenSymbol: 'YFII',
    icon: '🦪',
  },
  // KAOYA End
  ...
  // Burn
  {
    ...
    tokenAddresses: {
      42: '0x0000000000000000000000000000000000000000',
      1: '0xAe4f3a27289d49BA3cF3Dc572495Bf07C00878D2', // 0x00 actual
    },
    name: 'Reduce Mint',
    symbol: 'Nothing',
    tokenSymbol: 'KAOYA',
